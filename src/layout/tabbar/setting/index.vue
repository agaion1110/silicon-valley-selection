<template>
    ...
    <img :src="user.avatar" style="width: 24px;height: 24px;margin:0px 10px;border-radius: 50%;">
    <!-- 下拉菜单 -->
    <el-dropdown>
        ...
        <template #dropdown>
            <el-dropdown-menu>
                <el-dropdown-item @click="logout"><el-icon><Unlock /></el-icon>退出登录</el-dropdown-item>
            </el-dropdown-menu>
        </template>
    </el-dropdown>
</template>
